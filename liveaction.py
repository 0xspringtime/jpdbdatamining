...
# Fetch the webpage
base_url = 'https://jpdb.io/live-action-difficulty-list?offset='
...
for page in pages:
    ...
    sheet.append(['Title', 'Length (in words)', 'Unique words', 'Unique words (used once)', 'Unique words (used once %)', 'Unique kanji', 'Unique kanji (used once)', 'Unique kanji readings', 'Difficulty'])
